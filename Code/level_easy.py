...
from LEVEL1 import OpenGLWidget as Level1OpenGLWidget  

class EasyLevelWidget(QWidget):
    def __init__(self, central_widget, stacked_widget, parent=None):
        super(EasyLevelWidget, self).__init__(parent)
        ...
        self.opengl_widget = Level1OpenGLWidget(self)
...
if __name__ == "__main__":
    ...
    window = EasyLevelWidget(None, None)
    window.show()
    sys.exit(app.exec_())   